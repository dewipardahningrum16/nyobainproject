		...
		<div class="row">
            <div class="border padding20 span10" style="background-color: #F5F5F5;">
				<div class="panel no-border">
					<?php
						$comot=	mysql_query("SELECT * FROM setup_dasboard ORDER BY id_dasboard DESC LIMIT 3");   
			...
			<div class="padding20 span4" style="background-color: #F1F1F1;">
				...
				<div class="panel no-border">
                    ...
                    <div class="panel-content fg-dark nlp nrp">
						...
						<?php
						$comot_komen = mysql_query("SELECT * FROM komentar ORDER BY id_komentar DESC LIMIT 5");   
						while($ngisi_komen = mysql_fetch_array($comot_komen)){
