...
if(isset($_SESSION['user_admin'])){
	...
	{
		mysql_query("UPDATE setup_sumbar SET kat_sumbar='profil', judul_sumbar='$judul', konten_sumbar='$_POST[konten]' WHERE id_sumbar= '$_POST[id]'");
...
<head>
    ...
    <title>Setup Profil Sumbar</title>
        ...
        <div id="page-wrapper">
            <div class="row col-lg-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading"><h3>Setup Profil Sumbar</h3></div>
                    <div class="panel-body">
                        <div class="row col-lg-10">
                        	<form name="setupSumbarProfil" action="setupSumbarProfil.php" method="post" enctype="multipart/form-data">
							<?php
								if (isset($_GET['id']))
								{
                    ...
                    <div class="panel-body">
                        <div class="row col-lg-10">
                        	<table class="table table-hover table-striped">
                                ...
                                <?php
									$no=1;
									$comot=mysql_query("select * from setup_sumbar where kat_sumbar='profil' order by id_sumbar");
