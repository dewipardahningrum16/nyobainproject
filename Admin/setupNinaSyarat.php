...
if(isset($_SESSION['user_admin'])){
	...
	{
		mysql_query("INSERT INTO setup_about (kat_about, judul_about, konten_about)
				value ('syarat', '$judul', '$_POST[konten]')")
				or die(mysql_error());
	}
	
	else if(isset($_POST['Edit']))
	{
		mysql_query("UPDATE setup_about SET kat_about='syarat', judul_about='$judul', konten_about='$_POST[konten]' WHERE id_about= '$_POST[id]'");
	
	}
	
	else if(isset($_POST['Delete']))
	{
		mysql_query("DELETE FROM setup_about WHERE id_about = '$_POST[id]'");
...
<head>
    ...
    <title>Setup Syarat dan Ketentuan</title>
        ...
        <div id="page-wrapper">
            <div class="row col-lg-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading"><h3>Setup Syarat dan Ketentuan</h3></div>
                    <div class="panel-body">
                        <div class="row col-lg-10">
                        	<form name="setupNinaSyarat" action="setupNinaSyarat.php" method="post" enctype="multipart/form-data">
							<?php
								if (isset($_GET['id']))
								{
								$comot_id=mysql_query("select * from setup_about where id_about=".$_GET['id']);   
							...
							?>
                                <fieldset>
                                	...
                                	<div class="form-group">
                                    	<label>Judul</label>
                                        <input class="form-control" name="judul" type="text" placeholder="Input judul content" 
                    ...
                    <div class="panel-body">
                        <div class="row col-lg-10">
                        	<table class="table table-hover table-striped">
                                ...
                                <?php
									$no=1;
                                    $comot=mysql_query("select * from setup_about where kat_about='syarat' order by id_about");
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <div class="tooltip-demo">
                                            <a href="setupNinaSyarat.php?id=<?php echo $isi_tbl[0]; ?>"><button type="button" class="btn btn-primary btn-xs"data-toggle="tooltip" data-placement="top" title="Edit/Hapus Content Syarat dan Ketentuan"><i class="fa fa-wrench"></i></button></a>
                                   		</div>
                                        </td>
                                    </tr>
                                <?php
