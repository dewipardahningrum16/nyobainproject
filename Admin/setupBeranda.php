...
if(isset($_SESSION['user_admin'])){
	...
	if(isset($_POST['Tambah'])){
		mysql_query("INSERT INTO setup_dasboard (nama, konten, gambar) value ('$judul', '$_POST[konten]', '')") or die(mysql_error());
		
	}
	
	else if(isset($_POST['Edit'])){		
		if(empty($_POST['image'])){
			mysql_query("UPDATE setup_dasboard SET nama ='$judul', konten ='$_POST[konten]' WHERE id_dasboard = '$_POST[id]'");
		}
		...
		if(!empty($lokasi_file)){
			...
			mysql_query("UPDATE setup_dasboard SET nama ='$judul', konten ='$_POST[konten]', gambar='$nama_file' WHERE id_dasboard = '$_POST[id]'");
			
		}
	}
	
	else if(isset($_POST['Delete'])){
		mysql_query("DELETE FROM setup_dasboard WHERE id_dasboard = '$_POST[id]'");
                    ...
                    <div class="panel-body">
                        <div class="row col-lg-10">
							...
							<?php
                                if (isset($_GET['id']))
                                {
                                $comot_id=mysql_query("select * from setup_dasboard where id_dasboard=".$_GET['id']);   
                    ...
                    <div class="panel-body">
                        <div class="row col-lg-10">
                        	<table class="table table-hover table-striped">
                                ...
                                <?php
									$no=1;
                                    $comot=mysql_query("SELECT * FROM setup_dasboard ORDER BY id_dasboard DESC");
