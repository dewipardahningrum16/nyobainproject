...
if(isset($_SESSION['user_admin'])){
	...
	{
		mysql_query("UPDATE setup_sumbar SET kat_sumbar='sejarah', judul_sumbar='$judul', konten_sumbar='$_POST[konten]' WHERE id_sumbar= '$_POST[id]'");
...
<head>
    ...
    <title>Setup Sejarah Sumbar</title>
        ...
        <div id="page-wrapper">
            <div class="row col-lg-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading"><h3>Setup Sejarah Sumbar</h3></div>
                    ...
                    <div class="panel-body">
                        <div class="row col-lg-10">
                        	<table class="table table-hover table-striped">
                                ...
                                <?php
									$no=1;
									$comot=mysql_query("select * from setup_sumbar where kat_sumbar='sejarah' order by id_sumbar");
								...
								?>
                                    <tr>
                                        ...
                                        <div class="tooltip-demo">
                                            <a href="setupSumbarSejarah.php?id=<?php echo $isi_tbl[0]; ?>"><button type="button" class="btn btn-primary btn-xs"data-toggle="tooltip" data-placement="top" title="Edit/Hapus Content Sejarah"><i class="fa fa-wrench"></i></button></a>
                                   		</div>
                                        </td>
                                    </tr>
                                <?php
