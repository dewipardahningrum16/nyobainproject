...
if(isset($_SESSION['user_admin'])){
	...
	if(isset($_POST['Tambah']))
	{
		mysql_query("INSERT INTO setup_sumbar (kat_sumbar, judul_sumbar, konten_sumbar)
				value ('budaya', '$judul', '$_POST[konten]')")
				or die(mysql_error());
	}
	
	else if(isset($_POST['Edit']))
	{
		mysql_query("UPDATE setup_sumbar SET kat_sumbar='budaya', judul_sumbar='$judul', konten_sumbar='$_POST[konten]' WHERE id_sumbar= '$_POST[id]'");
...
<head>
    ...
    <title>Setup Seni dan Budaya Sumbar</title>
        ...
        <div id="page-wrapper">
            <div class="row col-lg-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading"><h3>Setup Seni dan Budaya Sumbar</h3></div>
                    <div class="panel-body">
                        <div class="row col-lg-10">
                        	<form name="setupSumbarBudaya" action="setupSumbarBudaya.php" method="post" enctype="multipart/form-data">
							<?php
								if (isset($_GET['id']))
								{
                    ...
                    <div class="panel-body">
                        <div class="row col-lg-10">
                        	<table class="table table-hover table-striped">
                                ...
                                <?php
									$no=1;
									$comot=mysql_query("select * from setup_sumbar where kat_sumbar='budaya' order by id_sumbar");
								...
								?>
                                    <tr>
                                        ...
                                        <div class="tooltip-demo">
                                            <a href="setupSumbarBudaya.php?id=<?php echo $isi_tbl[0]; ?>"><button type="button" class="btn btn-primary btn-xs"data-toggle="tooltip" data-placement="top" title="Edit/Hapus Content Budaya"><i class="fa fa-wrench"></i></button></a>
                                   		</div>
                                        </td>
                                    </tr>
                                <?php
