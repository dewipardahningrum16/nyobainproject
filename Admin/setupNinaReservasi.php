...
if(isset($_SESSION['user_admin'])){
	...
	{
		mysql_query("UPDATE setup_about SET kat_about='reservasi', judul_about='$judul', konten_about='$_POST[konten]' WHERE id_about= '$_POST[id]'");
...
<head>
    ...
    <title>Setup Cara Booking Tour</title>
        ...
        <div id="page-wrapper">
            <div class="row col-lg-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading"><h3>Setup Cara Booking Tour</h3></div>
                    ...
                    <div class="panel-body">
                        <div class="row col-lg-10">
                        	<table class="table table-hover table-striped">
                                ...
                                <?php
									$no=1;
                                    $comot=mysql_query("select * from setup_about where kat_about='reservasi' order by id_about");
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <div class="tooltip-demo">
                                            <a href="setupNinaReservasi.php?id=<?php echo $isi_tbl[0]; ?>"><button type="button" class="btn btn-primary btn-xs"data-toggle="tooltip" data-placement="top" title="Edit/Hapus Content Reservasi"><i class="fa fa-wrench"></i></button></a>
                                   		</div>
                                        </td>
                                    </tr>
                                <?php
