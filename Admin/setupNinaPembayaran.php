...
if(isset($_SESSION['user_admin'])){
	...
	if(isset($_POST['Tambah']))
	{
		mysql_query("INSERT INTO setup_about (kat_about, judul_about, konten_about)
				value ('pembayaran', '$judul', '$_POST[konten]')")
				or die(mysql_error());
	}
	
	else if(isset($_POST['Edit']))
	{
		mysql_query("UPDATE setup_about SET kat_about='pembayaran', judul_about='$judul', konten_about='$_POST[konten]' WHERE id_about= '$_POST[id]'");
...
<head>
    ...
    <title>Setup Cara Pembayaran</title>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row col-lg-10">
                        	<form name="setupNinaPebayaran" action="setupNinaPembayaran.php" method="post" enctype="multipart/form-data">
							<?php
								if (isset($_GET['id']))
								{
                    ...
                    <div class="panel-body">
                        <div class="row col-lg-10">
                        	<table class="table table-hover table-striped">
                                ...
                                <?php
									$no=1;
                                    $comot=mysql_query("select * from setup_about where kat_about='pembayaran' order by id_about");
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <div class="tooltip-demo">
                                            <a href="setupNinaPembayaran.php?id=<?php echo $isi_tbl[0]; ?>"><button type="button" class="btn btn-primary btn-xs"data-toggle="tooltip" data-placement="top" title="Edit/Hapus Content Pembayaran"><i class="fa fa-wrench"></i></button></a>
                                   		</div>
                                        </td>
                                    </tr>
                                <?php
