    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
                ...
                <div class="panel-body">
                	<div class="table-responsive">
                        <table class="table table-hover table-striped" id="dataTables-transaksi">
                            ...
                            <tbody>
                            <?php
                                $comot=mysql_query("SELECT * FROM tbl_pesan, tbl_paket, tbl_hotel, tbl_user WHERE tbl_pesan.id_user=tbl_user.id_user AND tbl_pesan.id_paket=tbl_paket.id_paket AND tbl_pesan.id_hotel=tbl_hotel.id_hotel ORDER BY tgl_pesan DESC LIMIT 5");
                	...
                	<div class="table-responsive">
                        <table class="table table-hover table-striped" id="dataTables-transaksi">
                            ...
                            <?php
                                ...
                                $comot_bukti=mysql_query("SELECT * FROM tbl_bukti, tbl_pesan, tbl_user WHERE 
													tbl_bukti.id_pesan	= tbl_pesan.id_pesan AND
													tbl_pesan.id_user	= tbl_user.id_user");
                                while($isi_bukti=mysql_fetch_array($comot_bukti)) {
                            ?>
                                <tr>
                                    <td><?php echo $no++ ?></td>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                   	<?php
					$comot_comen=mysql_query("SELECT * FROM komentar ORDER BY waktu DESC LIMIT 3");
					while($isi_comen=mysql_fetch_array($comot_comen))
					{ ?>
					<div class="well">
