...
if(isset($_SESSION['username'])){
    ...
    $num = 'NINA00'.$isi_tbl['id_pesan'].' - ('.$isi_tbl['tgl_pesan'].')';
        ...
        <tr>
            <td colspan="2" style="width: 100%">
                <div class="zone" style="height: 34mm;position: relative;font-size: 5mm;">
                    ...
                    <img src="images/LOGO_NINA.png" width="100" height="99" />
					<span style="position: absolute; left: 32mm; top: 10mm; font-size: 28px; color: red">NINA tour and travel</span><br />
                    <span style="position: absolute; left: 32mm; top: 18mm; font-size: 16px;">Padang, <?php echo $date; ?></span>
