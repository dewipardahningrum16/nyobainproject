    ...
    <div class="container grid">
		<div class="row">
				<table class="table striped">
                    ...
                    <tbody>
                    <?php
						$comot=mysql_query("SELECT * FROM tbl_pesan, tbl_paket, tbl_hotel, tbl_user WHERE tbl_pesan.id_user=tbl_user.id_user AND tbl_pesan.id_paket=tbl_paket.id_paket AND tbl_pesan.id_hotel=tbl_hotel.id_hotel AND username='$username'");
